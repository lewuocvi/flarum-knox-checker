...
var CheckImeiPage = /*#__PURE__*/function (_Page) {
  ...
  _proto.view = function view() {
    ...
    }, m("h2", null, app.translator.trans('lewuocvi-knoxextchecker.forum.knox_result_title')), m("table", {
      className: "ResultTable"
    }, m("tbody", null, m("tr", null, m("td", null, app.translator.trans('lewuocvi-knoxextchecker.forum.knox_status'), ":"), m("td", null, this.result().registered ? app.translator.trans('lewuocvi-knoxextchecker.forum.registered_knox') : app.translator.trans('lewuocvi-knoxextchecker.forum.unregistered_knox'))), this.result().generalInfo && m("tr", null, m("td", null, app.translator.trans('lewuocvi-knoxextchecker.forum.company_name'), ":"), m("td", null, this.result().generalInfo.companyName)), this.result().generalInfo && m("tr", null, m("td", null, app.translator.trans('lewuocvi-knoxextchecker.forum.device_status'), ":"), m("td", null, this.result().generalInfo.deviceState)), m("tr", null, m("td", {
      colSpan: "2"
    }, this.result().message)))), m("div", {
      className: "clearPage"
    }, m("a", {
