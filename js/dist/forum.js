...
var DepositPage = /*#__PURE__*/function (_Page) {
  ...
  _proto.generateQRCode = /*#__PURE__*/function () {
    var _generateQRCode = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2() {
      var currentUser, response, _response$deposit, qrcode_url, content, message, amount;
          ...
          case 3:
            ...
            if (response.status === 'success') {
              this.depositHistory(response.data.map(function (deposit) {
                return {
                  id: deposit.id,
                  date: _this2.formatTimeAgo(new Date(deposit.created_at)),
...
var CheckImeiPage = /*#__PURE__*/function (_Page) {
  ...
  _proto.oninit = function oninit(vnode) {
    _Page.prototype.oninit.call(this, vnode);
    this.imei = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()('357301902793356'); //357301902793356
  ...
  _proto.initLoadingText = function initLoadingText() {
    var loadingText = this.element.querySelector('.LoadingText');
    if (!loadingText) return;
    var text = app.translator.trans('lewuocvi-knoxextchecker.forum.exploiting');
    var index = 0;
    var typingSpeed = 100; // Milliseconds per character
    var pauseBetweenLoops = 1000; // Pause before restarting
  ...
  _proto.view = function view() {
    return m("div", {
      ...
      className: "container"
    }, this.loading() === false && this.result() === null && m("div", {
      className: "containerForm"
