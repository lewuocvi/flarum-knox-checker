...
var CheckImeiPage = /*#__PURE__*/function (_Page) {
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.servicePrice = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()(0);
  };
  _proto.oncreate = function oncreate(vnode) {
    _Page.prototype.oncreate.call(this, vnode);
    // Set the page title
  ...
  _proto.requestAuthController = /*#__PURE__*/function () {
    var _requestAuthController = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee() {
      var response;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
          ...
          case 3:
            ...
            return app.request({
              method: 'GET',
              url: app.forum.attribute('apiUrl') + '/extension/OneTimePasswordVerify' + this.getQuerystring()
            });
          case 5:
    ...
    function requestAuthController() {
      return _requestAuthController.apply(this, arguments);
    }
    return requestAuthController;
  }();
  _proto.updateMetaTag = function updateMetaTag(name, content) {
    var metaTag = document.querySelector("meta[name=\"" + name + "\"]");
    if (!metaTag) {
  ...
  _proto.loadUserData = /*#__PURE__*/function () {
    var _loadUserData = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2() {
      var response, _response$service_pri;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
          ...
          case 4:
            ...
            if (response.status === 'success' && response.user) {
              ...
              this.servicePrice((_response$service_pri = response.service_price) != null ? _response$service_pri : 0);
            }
            _context2.next = 13;
            break;
          case 9:
  ...
  _proto.checkImei = /*#__PURE__*/function () {
    var _checkImei = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee3(e) {
      var response;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return _context3.abrupt("return", this.handleError(app.translator.trans('lewuocvi-knoxextchecker.forum.login_required')));
          case 5:
            _context3.prev = 5;
            _context3.next = 8;
            return app.request({
  ...
  _proto.view = function view() {
    ...
    }, " ", app.translator.trans('lewuocvi-knoxextchecker.forum.check_button'), " "))))), this.wallet() && m("div", {
      className: "UserInfo"
    }, m("table", {
    ...
    }, m("h2", null, app.translator.trans('lewuocvi-knoxextchecker.forum.error_title')), m("p", null, this.result().message)))));
  };
