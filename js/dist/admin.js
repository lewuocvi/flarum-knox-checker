...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('lewuocvi/knoxextchecker', function () {
  console.log('[lewuocvi/knoxextchecker] Hello, admin!');
});
